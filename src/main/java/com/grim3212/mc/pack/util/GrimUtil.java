...
@Mod(modid = GrimUtil.modID, name = GrimUtil.modName, version = GrimCore.modVersion, dependencies = "required-after:grimcore", guiFactory = "com.grim3212.mc.pack.util.config.ConfigGuiFactory")

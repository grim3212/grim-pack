...
public class ToolsClientProxy extends ClientProxy {
	...
	public void preInit() {
		...
		//RenderingRegistry.registerEntityRenderingHandler(EntitySlingpelletExplosive.class, new RenderThrowableFactory(ToolsItems.explosive_sling_pellet));
		//RenderingRegistry.registerEntityRenderingHandler(EntitySlingpelletFire.class, new RenderThrowableFactory(ToolsItems.fire_sling_pellet));
		//RenderingRegistry.registerEntityRenderingHandler(EntitySlingpelletLight.class, new RenderThrowableFactory(ToolsItems.light_sling_pellet));
		//RenderingRegistry.registerEntityRenderingHandler(EntitySlingpelletNetherrack.class, new RenderThrowableFactory(ToolsItems.netherrack_sling_pellet));
		//RenderingRegistry.registerEntityRenderingHandler(EntitySlingpelletSlime.class, new RenderThrowableFactory(ToolsItems.slime_sling_pellet));

...
public class EntityKnife extends EntityProjectile {
	...
	public EntityKnife(World world, EntityLivingBase shooter, EntityLivingBase entityliving, float par4, float par5) {
		super(world, shooter, entityliving, par4, par5);
		this.setDamage(2.0D);
	}

	public EntityKnife(World world, EntityLivingBase shooter, float par3) {

...
public class EntityIceCube extends Entity {
	...
	public void onUpdate() {
		...
		MovingObjectPosition movingobjectposition = this.worldObj.rayTraceBlocks(vec3d, vec3d1, false, true, false);
		...
		if (movingobjectposition != null) {
			if (movingobjectposition.entityHit != null) {
				...
				if (movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, shootingEntity), j)) {
					worldObj.playSoundAtEntity(this, "random.wood_click", 1.0F, 1.2F / (rand.nextFloat() * 0.2F + 0.9F));
					setDead();

...
public class CommonItems {
	...
	public static final Item aluminum_ingot = (new ItemManualPage("aluminum_ingot", "core:aluminum.aluminum", GrimCreativeTabs.GRIM_CORE));
	public static final Item aluminum_can = (new ItemManualPage("aluminum_can", "core:aluminum.aluminum_can", GrimCreativeTabs.GRIM_CORE));
	public static final Item aluminum_shaft = (new ItemManualPage("aluminum_shaft", "core:aluminum.aluminum_shaft", GrimCreativeTabs.GRIM_CORE));
	public static final Item steel_shaft = (new ItemManualPage("steel_shaft", "core:steel.steel_shaft", GrimCreativeTabs.GRIM_CORE));
	public static final Item steel_ingot = (new ItemManualPage("steel_ingot", "core:steel.steel_ingot", GrimCreativeTabs.GRIM_CORE));
	public static final Item rubber = (new ItemManualPage("rubber", "core:common.rubber", GrimCreativeTabs.GRIM_CORE));
	public static final Item iron_stick = (new ItemManualPage("iron_stick", "core:common.iron_stick", GrimCreativeTabs.GRIM_CORE));
	public static final Item coal_dust = (new ItemManualPage("coal_dust", "core:common.coal_dust", GrimCreativeTabs.GRIM_CORE));
	public static final Item graphite = (new ItemManualPage("graphite", "core:common.graphite", GrimCreativeTabs.GRIM_CORE));
	public static final Item graphite_rod = (new ItemManualPage("graphite_rod", "core:common.graphite_rod", GrimCreativeTabs.GRIM_CORE));

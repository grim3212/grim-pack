...
public class BlockSlope extends BlockSlopedRotate {

	private static final AxisAlignedBB BASE_BOTTOM_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.5f, 1.0F);
	private static final AxisAlignedBB EAST_BOTTOM_AABB = new AxisAlignedBB(0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
	private static final AxisAlignedBB NORTH_BOTTOM_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.5F);
	private static final AxisAlignedBB WEST_BOTTOM_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 0.5F, 1.0F, 1.0F);
	private static final AxisAlignedBB SOUTH_BOTTOM_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.5F, 1.0F, 1.0F, 1.0F);

	private static final AxisAlignedBB BASE_TOP_AABB = new AxisAlignedBB(0.0F, 0.5F, 0.0F, 1.0F, 1.0F, 1.0F);
	private static final AxisAlignedBB EAST_TOP_AABB = new AxisAlignedBB(1.0D, 0.0D, 0.0D, 0.5D, 1.0D, 1.0D);
	private static final AxisAlignedBB NORTH_TOP_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 0.5D);
	private static final AxisAlignedBB WEST_TOP_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 0.5D, 1.0D, 1.0D);
	private static final AxisAlignedBB SOUTH_TOP_AABB = new AxisAlignedBB(0.0D, 0.0D, 1.0D, 1.0D, 1.0D, 0.5D);

...
public class ContainerIronWorkbench extends WorkbenchContainer {
	...
	public ContainerIronWorkbench(PlayerEntity player, World world, BlockPos pos, boolean isPortable) {

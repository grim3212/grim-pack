...
public class BlockGlowstoneTorch extends TorchBlock implements IManualBlock {
	...
	protected BlockState getState() {
		return this.blockState.getBaseState().withProperty(FACING, Direction.UP).withProperty(BlockFlipFlopTorch.ON, false);
	}

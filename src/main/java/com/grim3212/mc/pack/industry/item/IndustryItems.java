...
public class IndustryItems implements IPartItems {
	...
	public void initItems() {
		...
		steel_axe = (new AxeItem(steel, 8.0f, -3.1f)).setUnlocalizedName("steel_axe").setCreativeTab(GrimIndustry.INSTANCE.getCreativeTab());
		...
		gravity_boots = (new ItemArmor(gravboots, 4, EntityEquipmentSlot.FEET)).setUnlocalizedName("gravity_boots").setCreativeTab(GrimIndustry.INSTANCE.getCreativeTab());
		anti_radiation_boots = (new ItemArmor(antiRadiation, 3, EntityEquipmentSlot.FEET)).setUnlocalizedName("anti_radiation_boots").setCreativeTab(GrimIndustry.INSTANCE.getCreativeTab());
		anti_radiation_legs = (new ItemArmor(antiRadiation, 3, EntityEquipmentSlot.LEGS)).setUnlocalizedName("anti_radiation_legs").setCreativeTab(GrimIndustry.INSTANCE.getCreativeTab());
		anti_radiation_chest = (new ItemArmor(antiRadiation, 3, EntityEquipmentSlot.CHEST)).setUnlocalizedName("anti_radiation_chest").setCreativeTab(GrimIndustry.INSTANCE.getCreativeTab());
		anti_radiation_helmet = (new ItemArmor(antiRadiation, 3, EntityEquipmentSlot.HEAD)).setUnlocalizedName("anti_radiation_helmet").setCreativeTab(GrimIndustry.INSTANCE.getCreativeTab());

...
public class TexturedBuilder {
	...
	public IBakedModel makeBakedModel() {
		if (this.builderTexture == null) {
			...
			return new FurnitureModel(this.builderGeneralQuads, this.builderFaceQuads, this.builderAmbientOcclusion, this.builderGui3d, this.builderTexture, this.builderCameraTransforms);
		}
	}

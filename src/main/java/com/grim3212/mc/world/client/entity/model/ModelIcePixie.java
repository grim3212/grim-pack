package com.grim3212.mc.world.client.entity.model;
...
public class ModelIcePixie extends ModelBiped {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		float f8 = 0.0F;
		float f9 = 0.1875F;
		renderer.pos(d5, d8, d9).tex(f7, f9).endVertex();
		renderer.pos(d5, d7, d9).tex(f7, f8).endVertex();
		renderer.pos(d3, d7, d9).tex(f6, f8).endVertex();
		renderer.pos(d3, d8, d9).tex(f6, f9).endVertex();
		renderer.pos(d5, d8, d10).tex(f7, f9).endVertex();
		renderer.pos(d5, d7, d10).tex(f7, f8).endVertex();
		renderer.pos(d3, d7, d10).tex(f6, f8).endVertex();
		renderer.pos(d3, d8, d10).tex(f6, f9).endVertex();
		tessellator.draw();
		int i = 8;
		int j = 6;
		...
		for (int k = 0; k < i; k++) {
			...
			renderer.pos(f23, d7, 0.0F + f12).tex(f19, f8).normal(-1F, 0.0F, 0.0F).endVertex();
			renderer.pos(f23, d7, 0.0D).tex(f19, f8).normal(-1F, 0.0F, 0.0F).endVertex();
			renderer.pos(f23, d8, 0.0D).tex(f19, f9).normal(-1F, 0.0F, 0.0F).endVertex();
			renderer.pos(f23, d8, 0.0F + f12).tex(f19, f9).normal(-1F, 0.0F, 0.0F).endVertex();
		}
		tessellator.draw();
		...
		for (int l = 0; l < i; l++) {
			...
			renderer.pos(f24, d8, 0.0F + f12).tex(f20, f9).normal(1F, 0.0F, 0.0F).endVertex();
			renderer.pos(f24, d8, 0.0D).tex(f20, f9).normal(1F, 0.0F, 0.0F).endVertex();
			renderer.pos(f24, d7, 0.0D).tex(f20, f8).normal(1F, 0.0F, 0.0F).endVertex();
			renderer.pos(f24, d7, 0.0F + f12).tex(f20, f8).normal(1F, 0.0F, 0.0F).endVertex();
		}
		tessellator.draw();
		...
		for (int i1 = 0; i1 < j; i1++) {
			...
			renderer.pos(d3, f25, 0.0D).tex(f6, f21).normal(0F, 1.0F, 0.0F).endVertex();
			renderer.pos(d5, f25, 0.0D).tex(f7, f21).normal(0F, 1.0F, 0.0F).endVertex();
			renderer.pos(d5, f25, 0.0F + f12).tex(f7, f21).normal(0F, 1.0F, 0.0F).endVertex();
			renderer.pos(d3, f25, 0.0F + f12).tex(f6, f21).normal(0F, 1.0F, 0.0F).endVertex();
		}
		tessellator.draw();
		...
		for (int j1 = 0; j1 < j; j1++) {
			...
			renderer.pos(d5, f26, 0.0D).tex(f7, f22).normal(0F, -1.0F, 0.0F).endVertex();
			renderer.pos(d3, f26, 0.0D).tex(f6, f22).normal(0F, -1.0F, 0.0F).endVertex();
			renderer.pos(d3, f26, 0.0F + f12).tex(f6, f22).normal(0F, -1.0F, 0.0F).endVertex();
			renderer.pos(d5, f26, 0.0F + f12).tex(f7, f22).normal(0F, -1.0F, 0.0F).endVertex();
		}

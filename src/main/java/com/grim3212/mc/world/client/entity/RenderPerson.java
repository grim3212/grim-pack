...
public class RenderPerson extends RenderBiped<EntityCreature> {
	...
	public RenderPerson(RenderManager renderManager, ModelBiped model, float par2, ResourceLocation loc) {
		this(renderManager, model, par2, 1.0F, loc);
	}

	public RenderPerson(RenderManager renderManager, ModelBiped par1ModelBiped, float par2, float par3, ResourceLocation loc) {

...
public class WorldBlocks implements IPartItems {
	...
	public void initItems() {
		...
		gunpowder_reed_block = (new BlockGunpowderReed()).setStepSound(Block.soundTypeGrass).setHardness(0.0F).setLightLevel(0.5F).setResistance(200F).setUnlocalizedName("gunpowder_reed_block");
		glowstone_seeds = new BlockGlowstoneSeed().setHardness(0.0F).setResistance(0.0F).setStepSound(Block.soundTypeGlass).setUnlocalizedName("glowstone_seeds").setLightLevel(0.8F);
		corruption_block = (new BlockCorruption()).setHardness(1.0F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("corruption_block");
		fungus_growing = new BlockFungusGrowing().setHardness(0.0F).setResistance(0.0F).setUnlocalizedName("fungus_growing").setLightLevel(0.8F).setStepSound(Block.soundTypeGrass).setLightOpacity(10);
		fungus_building = new BlockFungusBuilding().setHardness(0.0F).setResistance(0.0F).setUnlocalizedName("fungus_building").setLightLevel(0.8F).setStepSound(Block.soundTypeGrass).setLightOpacity(10);
		fungus_killing = new BlockFungusKilling().setHardness(0.0F).setResistance(0.0F).setUnlocalizedName("fungus_killing").setLightLevel(0.8F).setStepSound(Block.soundTypeGrass).setLightOpacity(10);

...
public class RenderBallisticKnife extends Render<EntityBallisticKnife> {

	private static final ResourceLocation resourceLocation = new ResourceLocation(GrimTools.modID, "textures/entities/ballisticknifeRender.png");
	...
	@Override
	public void doRender(EntityBallisticKnife entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityBallisticKnife entity) {

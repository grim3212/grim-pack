...
public class GuiManualIndex extends GuiScreen {
	...
	public static final ResourceLocation texture = new ResourceLocation(GrimCore.modID + ":" + "textures/gui/guiManual.png");
	...
	protected void drawTitle() {
		...
		String title = StatCollector.translateToLocal("grim.manual.title");
	...
	protected void drawInfo() {
		if (page == 0) {
			...
			fontRendererObj.drawSplitString(StatCollector.translateToLocal("grim.manual.header"), x + 15, y + 28, 162, 0);
			fontRendererObj.setUnicodeFlag(unicode);
		}
	}

...
export const GRIMPARTS: GrimPart[] = [
  ...
  { name: "Grim Cuisine", info: "Cuisine contains food and health related items", shortName: "cuisine", sections: [{ name: "Chocolate", shortName: "chocolate", component: ChocolateComponent },] },
